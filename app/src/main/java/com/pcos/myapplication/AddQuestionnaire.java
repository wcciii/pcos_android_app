...
public class AddQuestionnaire extends AppCompatActivity {
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
                try {
                    if (url.equals("http://10.0.0.2:9000/pcos/login")) {
                        ...
                        URL url2 = new URL("http://10.0.0.2:9000/pcos/patient/" +
                                getIntent().getStringExtra("patientID") + "/patientquestionnaire/new");
