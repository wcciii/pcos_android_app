...
public class Login2Activity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVerifyCodeView = (EditText) findViewById(R.id.verify);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, password, verifyCode);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String email, String password, String verifyCode) {
            mEmail = email;
            mPassword = password;
        ...
        protected Boolean doInBackground(Void... params) {
            String url = "http://10.0.0.2:3000/verify";
            JSONObject jobj = new JSONObject();
            try {
                jobj.put("username", mEmail);
                jobj.put("verifyCode", mVerifyCode);
                jobj.put("password", mPassword);
            } catch (JSONException e) {
                e.printStackTrace();
            }
            DoPost doPost = new DoPost(url, jobj.toString());
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                mVerifyCodeView.setError("User is not found");
